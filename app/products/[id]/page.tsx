  ...
  return (
    <div className='product-container'>
        ...
        <div className='flex-1 flex flex-col'>
            ...
            <div className='product-info'>
                <div className='flex flex-col gap-2'>
                    ...
                    <p className='text-[21px] opacity-50 text-secondary font-bold line-through'>{product.currency} {formatNumber(product.originalPrice)}</p>
      ...
      {similarProducts && similarProducts?.length > 0 && (
        <div className='flex flex-col py-14 gap-2 w-full'>
